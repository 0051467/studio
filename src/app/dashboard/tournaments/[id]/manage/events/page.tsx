// src/app/dashboard/tournaments/[id]/manage/events/page.tsx
"use client";

import { EventManagementTab } from "@/components/tournaments/EventManagementTab";
...
export default function TournamentEventsPage() {
  ...
  return <EventManagementTab tournament={tournament} />;
}
