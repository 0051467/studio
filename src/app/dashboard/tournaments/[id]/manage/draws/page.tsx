// src/app/dashboard/tournaments/[id]/manage/draws/page.tsx
"use client";

import { DrawManagementTab } from "@/components/tournaments/DrawManagementTab";
...
export default function TournamentDrawsPage() {
  ...
  if (!tournament) {
    return (
      <Card>
        ...
        <CardContent>
          <p>Không thể tải chi tiết giải đấu để quản lý nhánh đấu.</p>
  ...
  return <DrawManagementTab tournament={tournament} />;
}
