// src/app/dashboard/tournaments/[id]/manage/players/page.tsx
"use client";

import { PlayerManagementTab } from "@/components/tournaments/PlayerManagementTab";
...
export default function TournamentPlayersPage() {
  ...
  if (!tournament) {
    return (
      <Card>
        ...
        <CardContent>
          <p>Không thể tải chi tiết giải đấu để quản lý vận động viên.</p>
  ...
  return <PlayerManagementTab tournament={tournament} />;
}
